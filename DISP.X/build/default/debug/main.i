...
const unsigned char seven_seg_digits[] = {
    0b00111111,
    0b00000110,
    0b01011011,
    0b01001111,
...
void setup();
void update_display(int sayi1, int sayi2);
...
void update_display(int sayi1, int sayi2) {
    ...
    PORTB = (unsigned char)((PORTB & 0xF0) | (seven_seg_digits[sayi1] & 0x0F));

    PORTB = (unsigned char)((PORTB & 0x0F) | ((seven_seg_digits[sayi2] << 4) & 0xF0));
}
    ...
    while (1) {
        if (RA0 == 1) {
            ...
            if (RA0 == 1) {
                ...
                update_display(display1, display2);
            }
        }
